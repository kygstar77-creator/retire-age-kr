    ...
    <section className="fm-card" style={S.card}>
      ...
      <div style={S.block}>
        <div style={S.blockTop}>
          <span style={S.blockLabel}>{t.incomeIsReal ? '저축률 (월 소득 대비)' : '저축률 (가용소득 추정 대비)'}</span>
...
const S = {
  ...
  incomeBtn: { display: 'block', width: '100%', textAlign: 'left', marginTop: 8, padding: '8px 10px', fontSize: 12, fontWeight: 600, color: '#6b6f76', background: '#faf8f4', border: '1px dashed #d7dae0', borderRadius: 9, cursor: 'pointer' },
