...
import glob
for f in ['src/firemap-v2/cafePosts.js', 'src/firemap-v2/cities.js', 'src/firemap-v2/cityTypeTest.js', 'src/firemap-v2/funName.js', 'src/components/firemap/FireTypeTest.jsx', 'src/components/firemap/ShareSheet.jsx'] + [g for g in glob.glob(os.path.join(ROOT, 'functions', '*.js')) if 'fonts' not in g]:
