...
const fields = [
  ...
  { group: 'basic', section: '기본', name: 'targetRetirementAge', label: '퇴사하고 싶은 나이', help: '이 나이에 회사를 그만둔다고 가정합니다.', suffix: '세' },
  ...
  { group: 'basic', section: '현금흐름', name: 'monthlyInvestment', label: '퇴사 전 매달 모을 돈', help: '월급에서 생활비를 쓰고 남겨 투자할 수 있는 금액입니다.', suffix: '원', money: true },
  { group: 'basic', section: '현금흐름', name: 'monthlyLivingCost', label: '퇴사 후 매달 쓸 생활비', help: '주거비, 식비, 보험료, 취미비까지 포함한 월 지출입니다.', suffix: '원', money: true },
  ...
  { group: 'advanced', section: '건강보험료', name: 'monthlyHealthInsurance', label: '예상 월 건강보험료', help: '지역가입자, 피부양자 여부에 따라 실제 금액은 달라질 수 있습니다.', suffix: '원', money: true },
  ...
  { group: 'advanced', section: '해외 체류', name: 'overseasApplyYears', label: '해외 체류 적용 기간', help: '퇴사 후 몇 년 동안 이 생활을 반복할지 입력하세요.', suffix: '년' }
];
