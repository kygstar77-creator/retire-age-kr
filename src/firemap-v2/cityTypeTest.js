...
export const TEST_CITIES = [
  ...
  { city: '우붓(발리)', country: '인도네시아', flag: '🇮🇩', dom: false, lat: -8.5, lon: 115.3, krw: 2300000, c1: '#10b981', c2: '#34d399', nature: 0.95, warm: 0.95, medical: 0.40, climate: 'hot', blurb: '발리 내륙 지역, 논밭과 요가 스튜디오가 많아요.' },
  { city: '쿠알라룸푸르', country: '말레이시아', flag: '🇲🇾', dom: false, lat: 3.1, lon: 101.7, krw: 2900000, c1: '#8b5cf6', c2: '#a78bfa', nature: 0.30, warm: 0.95, medical: 0.75, climate: 'hot', blurb: '말레이시아 수도, 대중교통과 쇼핑몰이 잘 갖춰졌어요.' },
  { city: '트빌리시', country: '조지아', flag: '🇬🇪', dom: false, lat: 41.7, lon: 44.8, krw: 2000000, c1: '#ef4444', c2: '#f87171', nature: 0.60, warm: 0.45, medical: 0.45, climate: 'cold', blurb: '조지아 수도, 구시가와 온천·와이너리가 있어요.' },
  { city: '리스본', country: '포르투갈', flag: '🇵🇹', dom: false, lat: 38.7, lon: -9.1, krw: 3800000, c1: '#0d9488', c2: '#2dd4bf', nature: 0.50, warm: 0.70, medical: 0.75, climate: 'mild', blurb: '포르투갈 수도, 대서양 연안의 언덕 도시예요.' },
  { city: '후쿠오카', country: '일본', flag: '🇯🇵', dom: false, lat: 33.6, lon: 130.4, krw: 3300000, c1: '#3b82f6', c2: '#60a5fa', nature: 0.45, warm: 0.60, medical: 0.85, climate: 'mild', blurb: '일본 규슈의 관문 도시, 한국에서 가까워요.' },
  { city: '방콕', country: '태국', flag: '🇹🇭', dom: false, lat: 13.7, lon: 100.5, krw: 2700000, c1: '#f59e0b', c2: '#fbbf24', nature: 0.20, warm: 0.95, medical: 0.70, climate: 'hot', blurb: '태국 수도, 대형 병원과 쇼핑몰이 많은 대도시예요.' },
...
export const ARCHETYPES = {
  lean:    { id: 'lean',    name: '린파이어 절약형', nick: '짠테크 수도승', emoji: '🧘', c1: '#475569', c2: '#94a3b8',
    tagline: '적게 쓰고 빨리 자유로워지는 미니멀리스트예요.', strong: '높은 저축률로 파이어를 가장 빨리 앞당겨요.', watch: '너무 조이면 지치기 쉬워요 · 가끔은 보상도 줘요.', match: 'fat', action: '자동이체로 저축률부터 끌어올리고, 고정비를 한 줄씩 줄여보요.' },
