...
export const TIPS = [
  ...
  ''얼마 모았나'보다 '몇 년치 생활비를 모았나'로 보면 진도가 또렷해요.',
...
export const DAILY_ACTIONS = [
  { ico: '⏱️', label: '오늘 쓴 돈 하나 줄이고 절약 기록하기', to: 'save' },
  { ico: '📈', label: '이번 달 자산 한 번 업데이트하기', to: 'home' },
  { ico: '🎛️', label: '바꿔보기로 '1년 더 일하면?' 실험하기', to: 'experiment' },
