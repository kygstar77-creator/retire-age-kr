...
export const TIPS = [
  ...
  '고정비(통신·구독·보험)부터 줄여요 · 한 번 줄이면 매달 평생 저축이 늘어요.',
...
export const DAILY_ACTIONS = [
  { ico: '⏱️', label: '오늘 한 걸음 기록하기', to: 'save' },
  { ico: '📈', label: '이번 달 자산 업데이트하기', to: 'home' },
  { ico: '🎛️', label: '조건 하나 바꿔 보기', to: 'experiment' },
  { ico: '🏆', label: '같은 구간에서 내 등수 보기', to: 'ranking' },
  { ico: '📍', label: '지방에 살면 몇 년 빨라지는지 보기', to: 'cities' },
  { ico: '💵', label: '배당으로 파이어 계산하기', to: 'dividend' },
  { ico: '🩺', label: '파이어 후 건보료 점검하기', to: 'dependent' },
  { ico: '💬', label: '방명록에 한마디 남기기', to: 'wall' }
];
