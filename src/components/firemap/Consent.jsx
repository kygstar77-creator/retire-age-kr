...
export default function ConsentSheet({ when = true }) {
  ...
  return (
    <Sheet open title="시작하기 전에">
      <p className="ds-p">파이어맵은 입력값을 기계적으로 계산하는 <b>계산 도구</b>예요. 투자·세무 자문이나 상품 권유가 아니에요. 실제 세금·건강보험료·연금은 제도와 상황에 따라 달라져요.</p>
      <p className="ds-caption ds-mt-2-5">입력값은 기기에서 계산돼요. 이름·연락처·계좌번호는 받지 않아요. 랭킹엔 자산 원금이 아닌 익명 점수(자산은 구간만)가 쓰여요. <a className="ds-link" href="/privacy">개인정보처리방침</a></p>
