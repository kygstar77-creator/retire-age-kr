...
export const questions = [
  ...
  { key: 'monthlyLivingCost', type: 'money', label: '파이어 후 생활비', title: '파이어 후 한 달에 얼마 써요?', helper: '주거·식비·보험·취미·여행까지 다 넣은 한 달 생활비예요.', step: 100000, presets: [2000000, 3000000, 4000000, 5000000], unit: '10만원 단위' }
];
...
export const overseasCities = [
  ['치앙마이', 2200000, '카페·코워킹·장기 체류 모임이 많은 대표 저비용 파이어 후보지', '비자: 관광·교육·파이어(O-A) 옵션 · 민간 의료보험 권장 · 건기 11~2월 쾌적'],
  ...
  ['방콕', 2700000, '없는 게 없는 대도시 인프라와 저렴한 외식·의료관광을 누리는 해외 FIRE 후보지', '비자: 관광·장기(은퇴) 옵션 · 사보험 권장 · 연중 무더위(건기 11~2월)'],
  ['우붓(발리)', 2300000, '논밭과 요가, 자연 속 힐링형 장기 해외살이 시나리오', '비자: 관광·B211/은퇴 옵션 · 사보험 필요 · 우기 11~3월'],
  ['세부', 2100000, '에메랄드 바다와 다이빙, 영어가 통하는 저비용 휴양형 후보지', '비자: 관광 연장·은퇴(SRRV) 옵션 · 사보험 필요 · 우기 6~11월 유의'],
  ['트빌리시', 2000000, '초저비용과 관대한 체류 조건, 와인·온천의 숨은 코스트파이어 성지', '비자: 다수 국적 장기 무비자 체류(요건 확인) · 사보험 권장 · 사계절 뚜렷'],
  ['리스본', 3800000, '온화한 유럽과 해산물·골목, 느린 오후를 누리는 낭만형 후보지', '비자: 유럽 장기(D7 등) 옵션(요건 까다로움) · 주거비 상승세 유의 · 온화'],
  ['후쿠오카', 3300000, '한국과 가깝고 음식·치안이 좋은, 도시와 자연이 한 시간인 후보지', '비자: 관광·장기 옵션 · 의료·치안 우수 · 사계절 · 근거리']
];
