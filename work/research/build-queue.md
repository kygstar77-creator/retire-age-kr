...
- [ ] thumb.py 에 손잡이 3개 추가 (2026-09-23 19:50 loop.py 가 스스로 '한계에 붙어 더 못 감'이라고 찍은 것)
  - short.white 0.0353 vs 경쟁 0.0107 — stroke_ratio 40(한계)로도 안 줄어듦. 흰색이 외곽선이 아니라 글자 채움에서 나온다. 글자 채움색/글자 크기 손잡이가 필요
