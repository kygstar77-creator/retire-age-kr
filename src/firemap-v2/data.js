...
export const domesticCities = [
  ['전주', 3000000, '한옥마을·대학병원·도심 생활권을 함께 보는 국내 장기 거주 후보지'],
  ['원주', 2800000, '수도권 접근성과 낮은 주거비를 같이 노리는 반퇴 생활 후보지'],
  ['강릉', 3300000, '바다와 도시 인프라를 포기하지 않으면서 생활비를 낮추는 시나리오']
];

export const overseasCities = [
  ['치앙마이', 2200000, '카페·코워킹·장기체류 커뮤니티가 강한 대표 저비용 FIRE 후보지'],
  ['다낭', 2400000, '따뜻한 기후와 낮은 체류비를 활용하는 단기 해외살이 시나리오'],
  ['쿠알라룸푸르', 2900000, '대도시 인프라와 영어 생활권을 함께 보는 해외 FIRE 후보지']
];
