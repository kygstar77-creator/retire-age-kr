...
export const DATA_SOURCES = {
  ...
  returnPresets: { label: '투자 수익률 가정', source: '주요 지수 장기 역사적 평균 기반 가정', asOf: '2026', note: '과거 수익률은 보장값이 아니고 투자 권유도 아니에요' },
  taxRules: { label: '세제·사회보험', source: '현행 세법·국민건강보험 제도', asOf: '2026', note: '제도 변경 시 결과가 달라질 수 있어요' },
  cityCost: { label: '도시 생활비', source: 'Numbeo 등 1인 월 생활비(주거 포함) 참고 추정치', asOf: '2026', note: '주거·의료·환율·비자에 따라 달라질 수 있어요', refreshPlanned: true },
