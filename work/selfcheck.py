...
TARGET = {   # 실측값. 지어낸 값이 아니다.
    # 1인칭 하한을 0으로 내렸다. 2026-09-26 사장님: "글쓴이를 내세우지 않는다 —
    # '제가 보기에', '제가 표를 만들어 놓고 보니', '저는 ~했어요'를 뺀다."
    # 전에는 하한 3%라서 1인칭을 뺀 글마다 지적이 떠, 다음 회차가 다시 넣게 만들었다.
    # 상한은 그대로 둔다 — 많이 쓰는 것은 여전히 문제다.
    'cafe': {'문장길이중앙': (24, 40), '습니다비율': (0.10, 0.35), '1인칭비율': (0.0, 0.20),
