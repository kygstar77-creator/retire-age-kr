...
export const questions = [
  { key: 'currentAge', type: 'age', label: '현재 나이', title: '지금 몇 살이에요?', helper: '여기서부터 파이어까지 남은 시간을 세요.', step: 1 },
  { key: 'targetRetirementAge', type: 'age', label: '목표 나이', title: '몇 살에 파이어하고 싶어요?', helper: '1살 차이로도 필요 자산이 많이 달라져요.', step: 1 },
  { key: 'financialAsset', type: 'money', label: '현재 자산', title: '지금 굴릴 수 있는 돈은 얼마예요?', helper: '저축·투자 등 금융자산 합계. 집은 빼요.', step: 1000000, presets: [0, 50000000, 100000000, 300000000], unit: '100만원 단위' },
  { key: 'monthlyInvestment', type: 'money', label: '월 저축액', title: '매달 얼마를 모아요?', helper: '앞으로 매달 투자하거나 저축할 돈이에요.', step: 100000, presets: [0, 500000, 1000000, 2000000], unit: '10만원 단위' },
  { key: 'monthlyLivingCost', type: 'money', label: '파이어 후 월 생활비', title: '파이어 후 한 달에 얼마 써요?', helper: '주거·식비·취미·여행을 넣은 한 달 생활비예요. 건강보험료는 따로 계산해요.', step: 100000, presets: [2000000, 3000000, 4000000, 5000000], unit: '10만원 단위' }
];
...
export const overseasCities = [
  ['치앙마이', 2200000, '카페와 코워킹 공간이 많은 태국 북부 도시예요', '비자: 관광·교육·은퇴(Non-O-A) 옵션 · 민간 의료보험 권장 · 건기 11~2월 쾌적'],
  ...
  ['우붓(발리)', 2300000, '논밭과 요가 스튜디오가 많은 발리 내륙 지역이에요', '비자: 관광·은퇴 옵션 · 사보험 필요 · 우기 11~3월'],
  ['세부', 2100000, '해변과 다이빙 명소가 많은 필리핀 섬이에요', '비자: 관광 연장·은퇴(SRRV) 옵션 · 사보험 필요 · 우기 6~11월 유의'],
  ['트빌리시', 2000000, '구시가와 온천·와이너리가 있는 조지아 수도예요', '비자: 한국인 무비자 1년 체류 · 사보험 권장 · 사계절 뚜렷'],
